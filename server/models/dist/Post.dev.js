...
var postSchema = new mongoose.Schema({
  ...
  owner: {
    ...
    //type of owner here object id mongoose.schema.type.objectid means id of owner
  ...
  {
    type: mongoose.Schema.Types.ObjectId,
    //type of likes here object id mongoose.schema.type.objectid means id of likes
    ref: "User" //ref means reference to user               
